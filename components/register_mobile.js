...
export default function RegisterMobile(){
    return(
    <div class=" register h-[100vh] overflow-scroll  bg-cover bg-center bg-no-repeat block 2xl:hidden" style={{ backgroundImage: `url(images/mobile_auth.png)`, height: '100vh'}}>
        <div class="w-full absolute text-white h-[100vh]  block 2xl:hidden md:top-[10rem]  top-[1rem] left-0 items-center text-center justify-center z-50">
            ...
            <div class="pt-[2rem] flex flex-col gap-6 w-full md:px-[6rem] px-[1rem]">
        ...
        <div className=" h-[200vh] md:h-[100vh] w-[100vw] top-0 opacity-80 mx-auto bg-black"></div>
